...
menu = input("Please choose 1 to input your ID code or choose 0 to exit the program: ")
if menu == "1":
   id_code = input("Please input your ID_code here: ")
elif menu == "0":
    print("Thank you and see you next time. To restart the program, please input RESTART ")
    quit()
else:
